...
public class TestingController {
	...
	public String testPage() {
		...
		String dummy = "";
		for (int i = 0; i<lstbiodata.size(); i++) {
			dummy += lstbiodata.get(i).getNik()+" - "; 
			dummy += lstbiodata.get(i).getNama()+" - ";
			dummy += lstbiodata.get(i).getAlamat()+" - ";
			dummy += lstbiodata.get(i).getId_salary()+"<br>";
		}
		return dummy;
	}
	...
	public String insertBiodata() {	
		...
		biodata.setNik("N07");
		biodata.setNama("Atiyah");
		biodata.setAlamat("Tambun");
		biodata.setId_salary(123);
		
		if(this.insertBiodata(biodata) == 1) {
			return "Insert Biodata Berhasil"+"<br>"+testPage();
		} else {
			return "Insert Biodata Gagal";			
		}
	}
	...
	public String updateBiodata() {	
		...
		Biodata biodata = new Biodata();
		biodata.setNik("N05");
		biodata.setNama("Umiiiiii aty");
		biodata.setAlamat("Tambun Selatan");
